...
const Featured = () => {
    return (
        <div className="featuredThem text-cyan-50">
            <SectionTitle
                heading="Check it Out"
                subHeading="Form our menu"
            ></SectionTitle>
            <div className="flex md:space-x-10 justify-center items-center mt-10 pb-7 p-8 mb-5">
                <div>
                ...
                <div>
                    ...
                    <button className="btn btn-outline uppercase text-2xl mt-4">Order Now</button>
                </div>
            </div>
        </div>
    );
